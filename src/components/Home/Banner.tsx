...
const Banner = () => {
  return (
    <main
      ...
      grid grid-row-3 grid-cols-[0.1fr,1fr,1fr] gap-1 pt-28"
    >
      <i className="col-start-1 col-end-2 row-start-1 row-end-4 flex flex-col gap-">
        <Dot
          color="white"
          size={50}
          strokeWidth={10}
      ...
      <div className="overflow-visible h-full col-start-3 col-end-4 row-start-1 row-end-4 -z-10">
        <Image
          width={1000}
          height={560}
